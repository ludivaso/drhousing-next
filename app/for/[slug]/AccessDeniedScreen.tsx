    ...
    <div className="min-h-screen bg-[#F5F2EE] flex items-center justify-center px-6">
      <div className="max-w-md text-center">
        ...
        <h1 className="font-serif text-2xl text-[#1A1A1A] mb-3">
          This list requires an updated access link
        </h1>
        <p className="text-[#6B6B6B] mb-8 leading-relaxed">
          Please contact Diego to receive your personal access link to this
          curated selection.
        </p>
        <a
        ...
        >
          {/* WhatsApp icon inline to avoid a Lucide import in a server component */}
          <svg
